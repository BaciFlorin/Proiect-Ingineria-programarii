    ...
    public class ClientController:IClientController
    {
        ...
        public void AdaugaImprumut(Carte carte, int userId)
        {
            ...
            if(!exista)
            {
                ...
                _view.AfiseazaMesaj("Cererea de imprumut a fost depusa!");
                
            }
            else
            {
                _view.AfiseazaMesaj("Ati imprumutat deja aceasta carte.");
            }
        }
        ...
        public void ReturneazaCarte(Imprumut imprumut)
        {
            ...
            _operatiiCerere.InserareCerereNoua(cerere);
            _view.AfiseazaMesaj("Cererea de restituire a fost depusa!");
        }

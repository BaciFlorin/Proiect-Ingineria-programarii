...
namespace Operatii
{
    ...
    /// </summary>
    public class OperatiiImprumut
    {
        private DatabaseConnection _dbConnection = DatabaseConnection.GetDbConnection();
        ...
        public void Insereaza(Imprumut imprumut)
        {
            ...
            result = _dbConnection.ExecutaComanda(commandText);
        ...
        public List<Imprumut> Selecteaza()
        {
            ...
            List<List<String>> imprumuturiDB = _dbConnection.ExecutaComandaSelect(commandText,
